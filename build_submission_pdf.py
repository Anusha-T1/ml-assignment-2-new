...
h1 { font-size: 17pt; color: #1f3864; border-bottom: 2px solid #1f3864;
     padding-bottom: 4px; }
h2 { font-size: 12pt; color: #1f3864; margin-top: 16px; }
...
th, td { border: 0.6pt solid #b9b9b9; padding: 4px 5px; text-align: left;
         vertical-align: top; }
th { background: #e8edf6; font-weight: bold; }
tr:nth-child(even) td { background: #fbfbfb; }
code, pre { font-family: "DejaVu Sans Mono", monospace; font-size: 7.5pt;
            background: #f5f5f5; }
pre { padding: 7px; border-left: 2.5pt solid #1f3864; white-space: pre-wrap; }
a { color: #1f3864; }
.cover { text-align: center; margin-bottom: 22px; }
.cover .sub { color: #555; font-size: 10pt; }
.links { border: 0.8pt solid #1f3864; border-radius: 4px; padding: 10px 14px;
...
<div class="cover">
  ...
  <div class="sub"><b>Wine Quality Classification</b> &mdash; comparison of six
  supervised classification models</div>
</div>
...
<div class="links">
  ...
  <div>Deployed on Streamlit Community Cloud. Provides an interactive frontend
  with CSV upload, a model selection dropdown, evaluation metrics, a confusion
  matrix, an ROC curve and a classification report.</div>
</div>
